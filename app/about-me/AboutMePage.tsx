            ...
            >
              ...
              <div className="flex flex-wrap gap-5">
                <ContactModal
                  ...
                  className="rounded-full px-8 py-6 h-auto text-base bg-blue-600 hover:bg-blue-700 text-white border-none transition-all duration-300 font-semibold"
                />
                <Link
                  target="_blank"
                  ...
                  className={cn(
                    ...
                    'rounded-full px-8 py-6 h-auto text-base border-white/10 hover:bg-white/5 text-white transition-all duration-300 gap-2 font-semibold',
                  )}
                >
