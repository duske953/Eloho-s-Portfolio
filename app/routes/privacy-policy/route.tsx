          ...
          <div className="flex flex-col gap-12 py-8">
            <Section title="1. Information We Collect">
              <ul className="list-disc max-sm:pl-3 space-y-4">
                <li>
                  Contact information (name, email address, business name)
                </li>
            ...
            <Section title="3. Data Sharing">
              <p>
                ...
                providers (e.g., email tools) to deliver services, and they
            ...
            <Section title="4. Data Security">
              <p>
                We follow standard practices to secure your data. If there’s
                ever a breach, we’ll notify you promptly as required by law.
              </p>
            </Section>
