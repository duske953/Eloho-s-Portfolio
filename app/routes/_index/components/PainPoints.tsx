...
function PainPointList({
  ...
  return (
    <motion.li
      ...
      className={cn(
        className,
        'h-full max-sm:col-span-2 max-sm:rotate-0 shadow-sm shadow-slate-800 w-full bg-blue-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-10 border-2 p-4'
      )}
    >
      <p>{point}</p>
    </motion.li>
