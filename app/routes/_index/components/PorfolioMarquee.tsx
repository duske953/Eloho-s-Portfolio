...
export default function PorfolioMarquee() {
  return (
    <section className="py-14 portfolio-container relative">
      <div className="absolute -top-96 mx-auto my-10 max-w-7xl rounded-3xl bg-gray-950/5 p-2 ring-1 ring-neutral-700/10 dark:bg-neutral-800 size-full">
